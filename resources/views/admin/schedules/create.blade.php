...
<div class="card" style="max-width: 800px;">
    <form action="{{ route('admin.schedules.store') }}" method="POST">
        ...
        <div class="card-footer text-right">
            <button type="submit" class="btn btn-primary"><i class="ri-save-line"></i> Simpan Jadwal</button>
        </div>
    </form>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    classroomSelect.addEventListener('change', function() {
        ...
        if (classId && classroomsData[classId]) {
            ...
            // Filter subjects by level and major (null major_id means Umum/Semua Jurusan)
    ...
    subjectSelect.addEventListener('change', function() {
        ...
        if (subjectId && subjectTeachers[subjectId]) {
            ...
            if (subjectTeachers[subjectId].length === 1) {
