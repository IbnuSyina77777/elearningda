...
Write-Host "Generating usecase_sistem.png ..."
Invoke-WebRequest -Uri "https://kroki.io/plantuml/png" -Method Post -Body $usecaseCode -ContentType "text/plain" -OutFile "c:\web\elearning\diagram\usecase_sistem.png"
Write-Host "Done!"
